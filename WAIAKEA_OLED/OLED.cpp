...
void OLED::init(uint8_t address)
{
...
void OLED::constructor(uint8_t w, uint8_t h) {
  _width = WIDTH = w;
  _height = HEIGHT = h;
...
void OLED::sendCommand(unsigned char command)
{
  ...
  Wire.write(command);
#else
  Wire.send(OLED_Command_Mode);	     // Set OLED Command mode
  Wire.send(command);
#endif
...
void OLED::clearArea(uint8_t x, uint8_t y, uint8_t w, uint8_t h)
{
	fillRect(x, y, w, h, BLACK);
}


void OLED::drawBitmap(uint8_t x, uint8_t y, 
...
// draw a character
void OLED::drawChar(int8_t x, int8_t y, unsigned char c, int8_t color, int8_t bg, uint8_t size) {
...
void OLED::setTextSize(uint8_t s) {
  textsize = (s > 0) ? s : 1;
}
...
void OLED::setTextColor(uint8_t c) {
  textcolor = c;
  textbgcolor = c; 
 ...
 void OLED::setTextColor(uint8_t c, uint8_t b) {
   textcolor = c;
   textbgcolor = b; 
 }

void OLED::setTextWrap(boolean w) {
  wrap = w;
}

// draw a rectangle
void OLED::drawRect(uint8_t x, uint8_t y, 
			    uint8_t w, uint8_t h, 
			    uint8_t color) {
...
void OLED::drawFastVLine(uint8_t x, uint8_t y, 
				 uint8_t h, uint8_t color) {
  // stupidest version - update in subclasses if desired!
  drawLine(x, y, x, y+h-1, color);
}

void OLED::drawFastHLine(uint8_t x, uint8_t y, 
...
void OLED::drawLine(uint8_t x0, uint8_t y0, 
...
void OLED::drawRoundRect(uint8_t x, uint8_t y, uint8_t w, uint8_t h, uint8_t r, uint8_t color) {
  // smarter version
...
void OLED::fillRoundRect(uint8_t x, uint8_t y, uint8_t w, uint8_t h, uint8_t r, uint8_t color) {
  // smarter version
...
// draw a triangle!
void OLED::drawTriangle(uint8_t x0, uint8_t y0,
				uint8_t x1, uint8_t y1, 
...
// fill a triangle!
void OLED::fillTriangle (uint8_t x0, uint8_t y0,
				uint8_t x1, uint8_t y1, 
				uint8_t x2, uint8_t y2, uint8_t color) {
...
void OLED::drawCircle(uint8_t x0, uint8_t y0, uint8_t r, 
			      uint8_t color) {
  int16_t f = 1 - r;
  int16_t ddF_x = 1;
  int16_t ddF_y = -2 * r;
...
void OLED::drawCircleHelper( uint8_t x0, uint8_t y0,
...
void OLED::fillCircle(uint8_t x0, uint8_t y0, uint8_t r, 
			      uint8_t color) {
...
void OLED::fillCircleHelper(uint8_t x0, uint8_t y0, uint8_t r,
...
void OLED::setRotation(uint8_t x) {
...
uint8_t OLED::width(void) { 
  return _width; 
}
 
uint8_t OLED::height(void) { 
  return _height; 
}
...
//OLED OLED;  // Preinstantiate Objects
